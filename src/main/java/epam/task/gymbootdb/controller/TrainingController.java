...
public interface TrainingController {
    ...
    List<TrainingDto> getTraineeTrainings(LocalDate fromDate, LocalDate toDate,
    ...
    List<TrainingDto> getTrainerTrainings(LocalDate fromDate, LocalDate toDate, Long trainerId);
}
